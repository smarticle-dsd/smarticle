    ...
    <>
      {isVisible ? (
        ...
        >
          ...
          {/*<div className={cs("tooltip-wrapper", className)}>*/}
          {/*<div
            className={cs(
              "tooltip-wrapper tooltip-wrapper-${currentFeatureIndex+1}",
              className,
            )}
            >*/}
          <div
          ...
          >
            ...
            {/*<>
              {currentTooltip === 0 ? (
                <div className={cs("tooltip-welcome-wrapper", className)}>
                  <FeatureTooltip
                    title=""
                    close={close}
                    firstButton="Skip"
                  ...
                  >
                    <div className={cs("tooltip-welcome", className)}>
                      <div className={cs("tooltip-welcome-title", className)}>
                        Welcome
                      </div>
                      <div className={cs("tooltip-welcome-text", className)}>
                        This is a quick tutorial to help you get familiar with
                        the basic functionality of Smarticle.
                        <br />
                        Go ahead and get started!
                        <br />
                        Yey!
              ...
              {currentTooltip === 1 ? (
                <div className={cs("tooltip-feature-wrapper", className)}>
                  <FeatureTooltip
                    title="1/3"
                    arrowType="top"
                    close={close}
                  ...
                  >
                    <div className={cs("tooltip-feature-text", className)}>
                      Click here to find details about paper’s references or
                      figures you want to check.
                    </div>
                  </FeatureTooltip>
                </div>
              ) : null}
              ...
              {currentTooltip === 2 ? (
                <div className={cs("tooltip-feature-wrapper", className)}>
                  ...
                  >
                    <div className={cs("tooltip-feature-text", className)}>
                      Clicking here will generate a knowledge graph of the
                      paper's references, you can check each reference’s detail
                      by clicking on specific node
                    </div>
                  </FeatureTooltip>
                </div>
              ) : null}
              ...
              {currentTooltip === 3 ? (
                <div className={cs("tooltip-feature-wrapper", className)}>
                  ...
                  >
                    <div className={cs("tooltip-feature-text", className)}>
                      By clicking here you will see the summary regarding the
                      paper, and you can also generate summaries of the text you
                      select.
                    </div>
                  </FeatureTooltip>
                </div>
